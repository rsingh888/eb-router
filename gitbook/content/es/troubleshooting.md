...
Problemas comunes y soluciones al usar ebRouter.
...
1. **Refresh automático (por defecto):**
   ebRouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si ebRouter está ejecutándose:**
   ```bash
   # Verifica el proceso
