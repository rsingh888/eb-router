...
ebRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

ebRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a ebRouter usando estas configuraciones:

**ebRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de ebRouter (cc/*, cx/*, glm/*, etc.)
```

**ebRouter en la nube:**
```
Base URL: https://ebrouter.example.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de ebRouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a ebRouter
```bash
# Verifica si ebRouter está corriendo
...
**Solución:**
- Verifica que ebRouter esté corriendo
...
- Verifica la conexión de red a ebRouter
