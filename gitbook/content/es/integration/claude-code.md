...
Integra ebRouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de ebRouter.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de ebRouter:
...
```bash
export ANTHROPIC_BASE_URL="https://ebrouter.example.com"
```
