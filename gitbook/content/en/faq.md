...
Common questions about ebRouter.

---

## What is ebRouter?

**ebRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**ebRouter uses a 3-tier pricing strategy:**
...
**Yes, ebRouter itself is 100% free and open source.**
...
**Yes! This is ebRouter's core feature.**
...
**ebRouter tracks quota in real-time for all providers:**
...
## Can I self-host ebRouter?

**Yes! ebRouter supports multiple deployment options:**
...
**Yes, ebRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.9router` (or custom `DATA_DIR`)
- No data sent to ebRouter servers
...
**What ebRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What ebRouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/YOUR_ORG/ebRouter/blob/main/CHANGELOG.md)
...
See [CONTRIBUTING.md](https://github.com/YOUR_ORG/ebRouter/blob/main/CONTRIBUTING.md) for details.
