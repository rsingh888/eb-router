...
Integrate ebRouter with Cline VSCode extension to route your AI requests through ebRouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- ebRouter running locally or cloud endpoint configured
...
Set the base URL to your ebRouter endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your ebRouter endpoint
...
3. The key should start with `sk-ebrouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your ebRouter configuration
...
4. Cline will use ebRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using ebRouter
...
3. Get AI-powered explanations through ebRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use ebRouter to understand context and make changes
...
1. Verify ebRouter is running: `curl http://localhost:20128/health`
...
2. Verify your ebRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check ebRouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use ebRouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://ebrouter.example.com`
2. Make sure you have configured your API key in the ebRouter cloud dashboard
...
## Integration with ebRouter Features

### Model Routing

ebRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, ebRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through ebRouter dashboard:
- Total requests
- Token usage
- Cost per model
