...
Integrate ebRouter with OpenAI Codex CLI to route your OpenAI API requests through ebRouter's intelligent routing system.
...
ebRouter provides the following Codex models:
...
1. Verify your API key is correct in ebRouter dashboard
...
1. Verify the model name matches your ebRouter configuration
2. Check that the OpenAI provider connection is active in ebRouter dashboard
...
Make sure you have configured your API key in the ebRouter cloud dashboard.
