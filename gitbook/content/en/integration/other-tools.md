...
ebRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

ebRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to ebRouter using these settings:

**Local ebRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any ebRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to ebRouter
```bash
...
- Check network connection to ebRouter
