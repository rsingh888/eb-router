...
Integrate ebRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- ebRouter API key from [dashboard](https://ebrouter.example.com/dashboard)
- ebRouter running (local or cloud)
...
### 2. Add ebRouter Model Configuration
...
3. Choose your preferred ebRouter model
...
- Check network latency to ebRouter
