...
Integrate ebRouter with Claude Code CLI to route your Anthropic API requests through ebRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to ebRouter models:
