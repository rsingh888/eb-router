...
Common issues and solutions when using ebRouter.
...
1. **Auto-refresh (default):**
   ebRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if ebRouter is running:**
   ```bash
   # Check process
