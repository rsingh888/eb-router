...
ebRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをebRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはebRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
