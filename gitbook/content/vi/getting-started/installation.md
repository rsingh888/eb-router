...
Hướng dẫn cài đặt chi tiết cho ebRouter với mẹo troubleshooting.
...
Cài ebRouter toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `ebrouter`
- ✅ Auto-update với `npm update -g ebrouter`
...
**Vấn đề:** ebRouter dùng quá nhiều RAM
