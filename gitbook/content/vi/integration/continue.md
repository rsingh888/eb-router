...
Tích hợp ebRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- ebRouter API key từ [dashboard](https://ebrouter.example.com/dashboard)
- ebRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model ebRouter
...
3. Chọn model ebRouter ưa thích
...
- Kiểm tra ebRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến ebRouter
