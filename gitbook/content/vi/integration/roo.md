...
Tích hợp ebRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model ebRouter có sẵn:
...
### Connection Failed
- Xác minh ebRouter đang chạy: `curl http://localhost:20128/health`
